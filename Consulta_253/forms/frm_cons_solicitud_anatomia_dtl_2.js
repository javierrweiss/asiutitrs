 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"86B46073-C226-499C-B66B-C089E31BA903"}
 */
function onShow_cargar_txt(firstShow, event) {
	globals.gbl_tip_nom = forms.frm_cons_solicitud_anatomia_dtl_1.foundset.aux_tipnom	
	globals.gbl_cod_nom = forms.frm_cons_solicitud_anatomia_dtl_1.foundset.aux_codnom
