 ...
 *
 * @properties={typeid:24,uuid:"A9E479AA-42D5-4838-A39F-01D16B4910C5"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"DF00B80F-ABA7-4AA1-B526-F04B84BCAAF8"}
 */
