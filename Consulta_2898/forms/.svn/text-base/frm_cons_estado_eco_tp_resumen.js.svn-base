 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"48393CE8-1C95-44DE-BBF5-0EA78B986BAC",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"B769BBBA-E102-4F02-A686-C393E85D4CFD"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"E28BAEE1-6A83-4D0C-AD7B-72F71C19618D"}
 */
 ...
 *
 * @properties={typeid:24,uuid:"4B45D3B6-6040-4321-9518-F1E7D2A08861"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"3C9311B5-EF49-482C-BB41-BF6C456669DF"}
 */
function filtra_visibles() {
	...
	foundset.sort('sector asc, tipmov asc, tipoprest_desc asc, concepto_desc asc, subconcepto asc, tipo asc')	
    foundset.find()
	visible = 1	
	foundset.search()	
	var $i = 200
