 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"F949A53A-35B8-4C3C-BFDB-28891596B7BF",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"B08B0848-F195-4E02-9B4A-7B02928C6E6A"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"AEB20069-A9FC-433C-9963-DC452F4D8500"}
 */
function onAction_buscar_comprobantes(event) {
	...
	if (tipo ==  6 && imp_per != null && boton_m == 0){
		...
		win.show(forms.frm_cons_estado_eco_comp_det_prest_cc)
 ...
 *
 * @properties={typeid:24,uuid:"68525E93-3365-4E4C-91DF-E389C04B1C18"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"63A4D09D-BB20-4A67-965C-2F4B74EE3C3A"}
 */
