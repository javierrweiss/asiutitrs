 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"6C85241E-C68A-4FB5-8ADC-B758BFF0B170",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"C31BD16C-786E-4332-8BC4-2396CE75E7DF"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"97945FD6-1626-4B59-81FB-82CD64670A38"}
 */
function onAction_buscar_comprobantes(event) {
	...
	if (tipo ==  6 && imp_per != null && boton_m == 0){
	    ...
	    win.show(forms.frm_cons_estado_eco_comp_det_snd)
 ...
 *
 * @properties={typeid:24,uuid:"407F63FF-3C38-4F35-8DF9-C97049B7AA98"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"C0A911A0-1DE9-4B27-9B19-9603C920B5B3"}
 */
function filtra_visibles() {
	...
	//foundset.sort('sector asc, tipo asc, razonsoc asc')	
	
	foundset.sort('tipmov asc, tipmov asc, tipoprest asc, tipo asc, razonsoc asc')
    foundset.find()
	visible = 1	
	foundset.search()	
	var $i = 200
