 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"3174F8C7-A738-4135-A1A5-1D0334C42B5E",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"453A7F05-C9CE-4842-B07D-4E6E2F258B41"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"E7DD3485-FE28-4BED-B6AF-BA99EBAF3266"}
 */
function onAction_buscar_comprobantes(event) {
	...
	if (tipo ==  6 && imp_per != ''&& boton_m == 0){
		var win = application.createWindow("det_comp4",JSWindow.MODAL_DIALOG)	
		win.title= 'Detalle de Comprobantes'
		win.resizable = false
		solutionModel.removeForm
	    win.show(forms.frm_cons_estado_eco_comp_det_finanzas_ug)
	    application.getWindow('det_comp4').hide()
	    application.getWindow('det_comp4').destroy() 
	}
}
 ...
 *
 * @properties={typeid:24,uuid:"714DA2B1-5155-4499-9B3E-5F911B4CE9C0"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"C2E49D0A-F776-4327-8E82-D7E00E569807"}
 */
