 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"2B9F546B-F872-4602-8551-8F33122C4E14",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"F39E0D41-9C55-4A77-BAA0-7AFF4873A684"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"35B2B0C0-E6C2-469A-BA36-EDDE6DD2D89D"}
 */
function onAction_buscar_comprobantes(event) {
	...
	if (tipo ==  6 && imp_per != null && boton_m == 0){
		var win = application.createWindow("det_comp3",JSWindow.MODAL_DIALOG)	
		win.title= 'Detalle de Comprobantes'
		win.resizable = false
		solutionModel.removeForm
		//var $name = 'frm_cons_estado_eco_comp_det_compras_cc'
		//history.removeForm($name)		
		//var $frm = solutionModel.getForm('frm_cons_estado_eco_comp_det_compras_cc')
		//$frm.dataSource = 'db:/desal/tbl_rrhh'
		//forms.frm_cons_estado_eco_comp_det_compras_cc.controller.recreateUI()			
	    win.show(forms.frm_cons_estado_eco_comp_det_compras_cc)
	    application.getWindow('det_comp3').hide()
	    application.getWindow('det_comp3').destroy() 
	}
}
 ...
 *
 * @properties={typeid:24,uuid:"4C6F1D3B-BFB5-4D71-A969-52ADEDE08A0F"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"3C0C879F-7446-486E-85BD-5319457CE86A"}
 */
