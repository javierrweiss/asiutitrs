/**
 * @properties={typeid:35,uuid:"C3BE7A3B-5936-460C-8A1F-0D663CCBB6A1",variableType:-4}
 */
var aux_periodo_tabla_subtotal = new Array();

/**
 * @properties={typeid:35,uuid:"4A0B236D-0CDE-4EDD-8CF0-2DDC95D07C3F",variableType:-4}
 */
var aux_periodo_tabla_subtotal_categclie = new Array(); 

/**
 * @properties={typeid:35,uuid:"9EABF334-9E8A-411A-B930-05550F3A457E",variableType:-4}
 */
var aux_periodo_tabla_totalgen = new Array();

/**
 * @properties={typeid:35,uuid:"FE1C0C58-981D-41CE-86FF-3BAD1B93B929",variableType:-4}
 */
var aux_periodo_tabla_totaltotal = new Array();
/**
 * @properties={typeid:35,uuid:"1F40EBD5-F3B3-4586-B16B-D9FD67551A2E",variableType:-4}
 */
var aux_resumen_ejec_totalvta = new Array();
/**
 * @properties={typeid:35,uuid:"09D8A3B6-D183-4DF3-BA98-57DD7E618457",variableType:-4}
 */
var aux_resumen_ejec_totalcosop = new Array();
/**
 * @properties={typeid:35,uuid:"63AD8C77-BDE6-4F4C-91E1-9CC8D80DCAC7",variableType:-4}
 */
var aux_resumen_ejec_totalconop = new Array();
/**
 * @properties={typeid:35,uuid:"E2AA167F-9BC9-4DFB-B43C-E3DBB7496C88",variableType:-4}
 */
var aux_periodo_tabla_totalgastos = new Array();

/**
 * @properties={typeid:35,uuid:"D2FFD784-A511-4490-96E5-0BD933BB56BC",variableType:-4}
 */
var aux_periodo_tabla_tot = new Array();

/**
 * @properties={typeid:35,uuid:"8ED2E1B3-2B0B-40D6-8533-DC2603A2C9B5",variableType:-4}
 */
var vector = new Array();

/**
 * @properties={typeid:35,uuid:"D9E73372-B6BE-44AD-9E68-9DE1FD1A3853",variableType:-4}
 */
 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"3F80A369-F273-4684-8799-7952B8EBA587",variableType:4}
 */
 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"7743655C-7D40-4F57-9B48-ED919C2DB834",variableType:4}
 */
var frm_index = 0;
 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"A1764941-3091-445D-BD50-B6DA675828B9",variableType:4}
 */
 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"A25468E0-A96E-45E3-BBEF-4CEAD155B8A3",variableType:4}
 */
var frm_tot_per3 = null;
/**
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"085E218A-DB4C-495C-9E9D-C18B740132E9",variableType:4}
 */
var frm_encontro = 0;
 ...
 *
 * @properties={typeid:24,uuid:"19457FC6-D76E-436F-BD06-048C9D4A0B1D"}
 * @AllowToRunInFind
 */
 ...
 * @returns {Boolean}
 *
 * @properties={typeid:24,uuid:"BB95D2A8-6C27-4082-A4F0-70A5BCABD999"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"CF94F434-E04C-4E42-8D0B-7FDC5D328C1B"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"24CB09A0-8B73-45FD-B8C1-16B4D6CB669B"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"60C4473F-2A7D-4BC9-B5B2-D75387D95175"}
 */
...
/**
 * @properties={typeid:24,uuid:"ACB138E7-FF98-4D5E-87FF-49E4B716A1C6"}
 */
...
/**
 * @properties={typeid:24,uuid:"DB4164CF-B954-476B-B4E8-59864DE64D17"}
 */
    	...
    	for (i= 1; i <= $max; i++){    		
			...
			switch (frm_index){	
				...
				case  5:
					...
					if(scopes.globals.gbl_codigo != 0){ 
					    $categ_rrhh = tbc_categ_to_tbc_categ.categ22; break
					}; break
				case 55:
			...
			if ($subconcep != subconcep_ant){
				...
				if(frm_index == 7){
		   		...
		   		if(frm_index == 5 || frm_index == 55 && subconcep_ant_imp == ''){
					subconcep_ant_imp = $categ_rrhh
				}
			    categclie_ant = null
				razonsoc_ant  = null			    
		    }
 ...
 * @param $col
 *
 * @properties={typeid:24,uuid:"A18BCCB0-65E4-428C-A1E3-CD84E47D5BA1"}
 */
function cargar_tabla2(razonsoc_ant, $razonsoc_aux, $visible, razonsoc_ant_des, tipmov_ant, tipoprest_ant, concepto_ant,
		...
		if ($sector == 1){
		    ...
		    if ($sector == 11){
		    	...
		    	$tit_aux = '                       Total '
		    	switch($sector){ 
			    case  2: $tit_aux = $tit_aux + 'Ventas'                    ; break
				case  3: $tit_aux = $tit_aux + 'Compras'                   ; break
				case  4: $tit_aux = $tit_aux + 'Prestaciones Médicas'      ; break
				case  5: $tit_aux = $tit_aux + 'RRHH'                      ; break
				case  6: $tit_aux = $tit_aux + 'Finanzas'                  ; break
				case  7: $tit_aux = $tit_aux + 'Impuestos'                 ; break
				case  8: $tit_aux = $tit_aux + 'Legales'                   ; break		
				case  9: $tit_aux = $tit_aux + 'SND'                       ; break
				case 10: $tit_aux = $tit_aux + 'Información Complementaria'; break
			}	
 				$tipo = 8
		    }
		}		
 ...
 * @param $mes_tit
 *
 * @properties={typeid:24,uuid:"F73E4044-FAE8-45B6-A8E5-9CEEC09B6DF1"}
 */
...
/**
 * @properties={typeid:24,uuid:"9E02BD05-924B-43BC-8D36-39472FB00EE8"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"C828BE69-2997-48D4-AE9E-B6CB3B50CE5C"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"F73F346B-18A6-454F-9947-9767AC9FC329"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"C3C2ADCB-3242-4CBF-9D0F-7FFE8F9F20D9"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"3EBB852A-6B68-42C0-A42D-AC727C7DA892"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"FB95D059-9ED9-4F92-A9F1-DD829DBD48CC"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"FC14D5BF-D109-4C71-8427-61EB935660D6"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"B622EA78-B3D8-4C60-8484-698CBC06E594"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"0B8E468B-23CC-4814-950D-9FCB2E5DAF75"}
 */
