 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"A01808F6-0269-4DA8-9A13-E582F2EE27B8",variableType:4}
 */
var frm_pos = 0;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"389F2CA7-5C71-4886-9BF0-D83C9B40668C"}
 */
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"B7B67FB6-166E-4D7A-9C41-AE2CAC4B5AF7"}
 */
function onAction_buscar_comprobantes(event) {
	...
	if (tipo ==  6 && imp_per != null && boton_m == 0){
	    ...
	    win.show(forms.frm_cons_estado_eco_comp_det_compras_ug)
 ...
 *
 * @properties={typeid:24,uuid:"7185CF75-0F6B-4D4B-9C09-0FE6C94C2847"}
 * @AllowToRunInFind
 */
 ...
 * @AllowToRunInFind
 *
 * @properties={typeid:24,uuid:"84719C79-8AEF-4EF6-87EB-BED3487C20EB"}
 */
