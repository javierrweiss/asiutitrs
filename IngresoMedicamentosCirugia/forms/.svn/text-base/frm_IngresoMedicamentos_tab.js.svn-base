 ...
 * @type {Number}
 *
 * @properties={typeid:35,uuid:"C2854E86-C680-455C-8218-8080F4E79C11",variableType:4}
 */
var vNroAnestesia = 0;
 ...
 * @type {String}
 *
 * @properties={typeid:35,uuid:"1CBF53B7-B741-489A-BE14-8A46E5A9703C"}
 */
var vString = '';
 ...
 * @type {String}
 *
 * @properties={typeid:35,uuid:"A9594474-9BFC-4F7B-B268-346133C124EB"}
 */
var vDatosQueFaltan = '';

/**
 * @properties={typeid:35,uuid:"8615D491-0E69-45A9-AA33-7118F4CBE798",variableType:-4}
 */
 ...
 *
 * @properties={typeid:24,uuid:"8AFCD37D-16FF-4F21-83DA-EA6045E00BF7"}
 * @AllowToRunInFind
 */
function onAction_Cantidad(event) {
	var tipoarticulo=''
	switch (vcodigomed_to_tbc_articulos.art_tipart){
	...
	if(globals.vCodigoMed!=0&&globals.vCantidad2259!=0){
		var thePressedButton = plugins.dialogs.showQuestionDialog('Confirma Grabación del '+ tipoarticulo, '¿Confirma la grabación del '+ globals.vCodigoMed + ' - ' + vcodigomed_to_tbc_articulos.art_descrip +' ?','Si','No');
	 	if (thePressedButton == "Si"){ 
	 		if(vestado2259_to_tbc_his_lectora.getSize()<1){
			/*
				forms.frm_his_lectora.foundset.newRecord()
			...
			*/
				...
				vestado2259_to_tbc_his_lectora.newRecord()
				globals.InicializarDatosRelacion(vestado2259_to_tbc_his_lectora,"asistencial","tbc_his_lectora")
				vestado2259_to_tbc_his_lectora.hlec_histclin=globals.vHiscli2259
				vestado2259_to_tbc_his_lectora.hlec_estado=globals.vEstado2259
				if(vcodigomed_to_tbc_articulos.art_medpide>0){
					vestado2259_to_tbc_his_lectora.hlec_art=vcodigomed_to_tbc_articulos.art_medpide
				}else{
					vestado2259_to_tbc_his_lectora.hlec_art=globals.vCodigoMed
				}
				vestado2259_to_tbc_his_lectora.hlec_cant=globals.vCantidad2259
				vestado2259_to_tbc_his_lectora.hlec_imed=globals.vImed
				vestado2259_to_tbc_his_lectora.hlec_protocolo=globals.vNroProtocolo2259
				//vestado2259_to_tbc_his_lectora.hlec_fec=anio_actual+''+mes_actual_ed+''+dia_actual_ed
				vestado2259_to_tbc_his_lectora.hlec_fec=utils.stringToNumber(globals.CapturaFechaSistema().toString())
				vestado2259_to_tbc_his_lectora.hlec_hora=utils.stringToNumber(globals.CapturaHoraSistema("HHMMSSDD").toString())
				vestado2259_to_tbc_his_lectora.hlec_feclec=vestado2259_to_tbc_his_lectora.hlec_fec
				vestado2259_to_tbc_his_lectora.hlec_horlec=vestado2259_to_tbc_his_lectora.hlec_hora
				vestado2259_to_tbc_his_lectora.hlec_fecing=vs3_to_tbc_cirugint.cirifechacarga
				vestado2259_to_tbc_his_lectora.hlec_horing=utils.stringToNumber(vs3_to_tbc_cirugint.cirihoracarga.toString().substr(0,4))
				vestado2259_to_tbc_his_lectora.hlec_legmed=vs3_to_tbc_cirugint.cirilegciru
				vestado2259_to_tbc_his_lectora.hlec_tiplegmed=vs3_to_tbc_cirugint.ciriieciru
				vestado2259_to_tbc_his_lectora.hlec_cama=vhiscli2259_unico_to_tbc_admision_scroll.adm_cama
				vestado2259_to_tbc_his_lectora.hlec_habita=vhiscli2259_unico_to_tbc_admision_scroll.adm_habita
				vestado2259_to_tbc_his_lectora.hlec_tiplegoper=globals.vTipoLegajo
				vestado2259_to_tbc_his_lectora.hlec_legoper=globals.vNroLegajo
				vestado2259_to_tbc_his_lectora.hlec_tiphistclin=globals.vTipoHC
				vestado2259_to_tbc_his_lectora.hlec_sector=globals.vSector
				try{
					databaseManager.saveData(vestado2259_to_tbc_his_lectora.getRecord(1))
				}catch(msg){
					plugins.dialogs.showErrorDialog("Error de Grabación","error de grabacion his-lectora "+msg.message)
				}
				...
				var array = databaseManager.getFailedRecords(vestado2259_to_tbc_his_lectora)
				...
				for(var i=1;i<=vestado2259_to_tbc_his_lectora.getSize()&&!encontrado;i++){
					vestado2259_to_tbc_his_lectora.setSelectedIndex(i)
					if(vestado2259_to_tbc_his_lectora.hlec_art==globals.vCodigoMed){
						encontrado = true
					}
				}
				if(encontrado){
					...
					var array1 = databaseManager.getFailedRecords(vestado2259_to_tbc_his_lectora)
				...
				seg = fecha_actual.getSeconds()
				mil = fecha_actual.getUTCMilliseconds()
				forms.frm_his_lectora.foundset.hlecfecha=anio_actual+''+mes_actual+''+dia_actual
				forms.frm_his_lectora.foundset.hlechora=hora+''+min+''+seg+''+mil.toString().substr(0,2)
				databaseManager.saveData(forms.frm_his_lectora.foundset.getRecord(1))
				*/
					elements.bean_243.visible=true
					...
					vestado2259_to_tbc_his_lectora.hlec_hora=utils.stringToNumber(globals.CapturaHoraSistema("HHMMSSDD").toString())
					//vestado2259_to_tbc_his_lectora.hlec_fec=anio_actual+''+mes_actual_ed+''+dia_actual_ed
					//vestado2259_to_tbc_his_lectora.hlec_hora=hora_ed+''+min_ed+''+seg_ed+''+mil_ed
					vestado2259_to_tbc_his_lectora.hlec_feclec=vestado2259_to_tbc_his_lectora.hlec_fec
					vestado2259_to_tbc_his_lectora.hlec_horlec=vestado2259_to_tbc_his_lectora.hlec_hora
					vestado2259_to_tbc_his_lectora.hlec_fecing=vs3_to_tbc_cirugint.cirifechacarga
					vestado2259_to_tbc_his_lectora.hlec_horing=utils.stringToNumber(vs3_to_tbc_cirugint.cirihoracarga.toString().substr(0,4))
					...
					elements.bean_243.visible=false
					//databaseManager.refreshRecordFromDatabase(vestado2259_to_tbc_his_lectora,1)
					var array2 = databaseManager.getFailedRecords(vestado2259_to_tbc_his_lectora)
					for (var jj = 0; jj < array2.length; jj++) {
						var record2 = array2[jj];
						var jstable2 = databaseManager.getTable(record2);
						var tableSQLName2 = jstable2.getSQLName();
						plugins.dialogs.showErrorDialog("Error de Grabación",'Tabla:' + tableSQLName2 + ' en server:' + jstable2.getServerName() + ' falló la grabación. Avise urgente a Sistemas, por favor!')
						plugins.dialogs.showErrorDialog("Error en grabación de vestado2259_to_tbc_his_lectora",record2.exception.getMessage());
						application.output(record2.exception);
						if (record2.exception.getErrorCode() == ServoyException.RECORD_VALIDATION_FAILED) {
						// exception thrown in pre-insert/update/delete event method
							var thrown2 = record2.exception.getErrorCode()
							application.output("Record validation failed: " + thrown2)
						}
					}
				}
			}
		/*
		fs1.find()
		 fs1['hlechiscli']=globals.vHiscli
		 fs1['hlecestado']=globals.value_one
		 fs1.search()
		 if(fs1.getSize()<1){
		 	fs1.newRecord()
		 	fs1['hlechiscli']=globals.vHiscli
		 	fs1['hlecart']=globals.vCodigoMed
		 	fs1['hleccan']=globals.vCantidad
		 	databaseManager.saveData(fs1.getRecord(1))
		 }else{
			 for(var i=1;i<=fs1.getSize()&&!encontrado;i++){
				 fs1.setSelectedIndex(i)
				 if(fs1['hlecart']==globals.vCodigoMed){
					 encontrado = true
				 }
			 }
			 if(encontrado){
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"360E3C70-48D4-4525-AB73-42EB06271796"}
 * @AllowToRunInFind
 */
function onAction_CodigoMed(event) {
	if(globals.vImed>0){
		...
		var hislectora_vacio=vestado2259_to_tbc_his_lectora.getSize()
		var largo = globals.vAlfaCodigoMed.length;
		var codigo_aux=0
		var esnumero = true;
		var encontrado = false;
		...
		for (var ii= 0;ii<largo && esnumero == true; ii++){
			if (globals.vAlfaCodigoMed.charCodeAt(ii)< 48 || globals.vAlfaCodigoMed.charCodeAt(ii) > 57){
				esnumero = false
			}
		}
		...
		if (esnumero){
			if(largo>6){
				...
				globals.vCodigoMed = utils.stringToNumber(globals.vAlfaCodigoMed.valueOf());
				if(vcodigomed_to_tbc_articulos.getSize()>0){
					for(var i=1;i<=vestado2259_to_tbc_his_lectora.getSize()&&!encontrado;i++){
						vestado2259_to_tbc_his_lectora.setSelectedIndex(i)
						if(vestado2259_to_tbc_his_lectora.hlec_art==globals.vCodigoMed){
							encontrado = true
							globals.vCantidad2259=vestado2259_to_tbc_his_lectora.hlec_cant
						}
					}
					if(encontrado){
			...
			globals.vAlfaCodigoMed = globals.vAlfaCodigoMed.toLocaleUpperCase()
			if(globals.vAlfaCodigoMed.charAt(0)=='B'&&globals.vAlfaCodigoMed.charCodeAt(1)>=48&&globals.vAlfaCodigoMed.charCodeAt(1)<=57){
			 	globals.vCodigoCombo=utils.stringToNumber(globals.vAlfaCodigoMed.toString())
			 ...
			 //plugins.dialogs.showInfoDialog("codigocombo",globals.vCodigoCombo)
			 	fs.find()
			 	fs['combnumero']=globals.vCodigoCombo
			 	fs['combtipo']=2
			 	fs.search()
			 	if(fs.getSize()<1){
			 		globals.vCodigoCombo=0
			 		var win = application.createWindow("c",JSWindow.MODAL_DIALOG)
			 		win.title = "Búsqueda de Combos de Medicamento y Descartable";
			 		win.setSize(480,550)
			 		win.show(forms.frm_busqueda_combo)
			 		if(globals.vCodigoCombo!=0){
			 			fs.find()
			 			fs['combnumero']=globals.vCodigoCombo
			 			fs['combtipo']=2
			 			fs.search()
			 	...
			 	if(busqueda_ok){
			 		var thePressedButton = plugins.dialogs.showQuestionDialog('Confirma Grabación de Combo', '¿Confirma la grabación del Combo '+ fs['combnombre']+' ?','Si','No');
			 			if (thePressedButton == "Si"){ 
							...
							for(var j=1;j<=60&&fs['combtart_'+j]>0;j++){
								globals.vCodigoArt_tmp=fs['combtart_'+j]
								if(vcodigoart_tmp_to_tbc_articulos.art_medpide>0){
									codigo_aux=vcodigoart_tmp_to_tbc_articulos.art_medpide
								}else{
							...
							/*
							if(hislectora_vacio>0){
								for(var h=1;h<=vestado2259_to_tbc_his_lectora.getSize()&&!encontrado;h++){
									vestado2259_to_tbc_his_lectora.setSelectedIndex(h)
									globals.vCodigoArt_tmp=fs['combtart_'+j]
									if(vcodigoart_tmp_to_tbc_articulos.art_medpide>0){
										if(vestado2259_to_tbc_his_lectora.hlec_art==vcodigoart_tmp_to_tbc_articulos.art_medpide){
											encontrado = true
										}
									}else{
										if(vestado2259_to_tbc_his_lectora.hlec_art==fs['combtart_'+j]){
											encontrado = true
										}
									}
							...
							*/
							//acacacacaca va el asterisco y la barra
							    var i=0
								if(encontrado){
									vestado2259_to_tbc_his_lectora.hlec_cant=fs['combtcan_'+j]
									vestado2259_to_tbc_his_lectora.hlec_combo=1
									try{
										databaseManager.saveData(vestado2259_to_tbc_his_lectora.getRecord(1))
									}catch(msg){
										plugins.dialogs.showErrorDialog("error his-lectora","Error al grabar vestado2259 en Combo")
									}
									var error3=''
									var error4=''
									var array1 = databaseManager.getFailedRecords(vestado2259_to_tbc_his_lectora)
									...
									if(error3!=''){
										plugins.dialogs.showErrorDialog("Error en grabacion de Combo - HIS-LECTORA",error3,"Ok")
										plugins.dialogs.showErrorDialog("Error en grabacion de Combo - HIS-LECTORA",error4,"Ok")
								...
								//plugins.dialogs.showInfoDialog("Inicializacion Post",'2')
									...
									globals.vCodigoArt_tmp=fs['combtart_'+j]
									if(vcodigoart_tmp_to_tbc_articulos.art_medpide>0){
										vestado2259_to_tbc_his_lectora.hlec_art=vcodigoart_tmp_to_tbc_articulos.art_medpide
									}else{
										vestado2259_to_tbc_his_lectora.hlec_art=fs['combtart_'+j]
									}
									vestado2259_to_tbc_his_lectora.hlec_cant=fs['combtcan_'+j]
									vestado2259_to_tbc_his_lectora.hlec_imed=globals.vImed
									vestado2259_to_tbc_his_lectora.hlec_protocolo=globals.vNroProtocolo2259
									...
									if(error1!=''){
										plugins.dialogs.showErrorDialog("Error en grabacion de Combo - HIS-LECTORA",error1,"Ok")
										plugins.dialogs.showErrorDialog("Error en grabacion de Combo - HIS-LECTORA",error2,"Ok")
										//plugins.dialogs.showInfoDialog("Reintentar","Reintente grabar!!")
									}
							...
							try{
								...
								plugins.dialogs.showErrorDialog("error his-lectora","Error al grabar vestado2259")
							}
							var error5=''
							var error6=''
							var array2 = databaseManager.getFailedRecords(vestado2259_to_tbc_his_lectora)
							for (i = 0; i < array2.length; i++) {
								...
								var jstable2 = databaseManager.getTable(record2);
								var tableSQLName2 = jstable2.getSQLName();
								error5='Error de Grabación en Tabla:' + tableSQLName2 + ' en server:' + jstable2.getServerName() + ' falló la grabación. Avise urgente a Sistemas, por favor!'
								error6='Error en grabación '+record2.exception;
								if (record2.exception.getErrorCode() == ServoyException.RECORD_VALIDATION_FAILED) {
							// exception thrown in pre-insert/update/delete event method
							...
							if(error5!=''){
								plugins.dialogs.showErrorDialog("Error en grabacion - HIS-LECTORA",error5,"Ok")
								plugins.dialogs.showErrorDialog("Error en grabacion - HIS-LECTORA",error6,"Ok")
								//plugins.dialogs.showInfoDialog("Reintentar","Reintente grabar!!")
							}
					...
					//plugins.dialogs.showInfoDialog("RefreshRecord Post",'2')
						...
						win1.show(forms.frm_busqueda_medicamentos)
					}
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"5B9A84AA-4972-4B6E-936C-D5AD5A0275CC"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"BADD80FF-0BFC-4A1A-AC85-DE5727FC2559"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"A44F7341-95B7-4F51-B69C-2EE8088DF999"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"0AC334E0-2066-4851-85B9-48D506CB017F"}
 * @AllowToRunInFind
 */
...
/**
 * @properties={typeid:24,uuid:"E716BEF1-9490-4D29-A7FA-3F478B7FF1F0"}
 */
...
/**
 * @properties={typeid:24,uuid:"5DEB6DCD-3D84-46D7-A621-F4D87BC17826"}
 * @AllowToRunInFind
 */
...
/**
 * @properties={typeid:24,uuid:"9EBAE34E-0C5C-429F-AB34-CE3797B63883"}
 */
...
/**
 * @properties={typeid:24,uuid:"3B5D680F-A5D6-4FF1-AA8E-72329C539B0A"}
 */
...
/**
 * @properties={typeid:24,uuid:"8E09CD40-C515-4BFC-B107-3E0B9DC7F648"}
 * @AllowToRunInFind
 */
...
/**
 * @properties={typeid:24,uuid:"F8E978AE-1E94-4496-BAEF-4DBCC4C6A48E"}
 */
 ...
 * @returns {Boolean}
 *
 * @properties={typeid:24,uuid:"ACF1D888-76D5-485D-A1CB-709FC6BEC69C"}
 */
...
/**
 * @properties={typeid:24,uuid:"71BCFBAE-A169-4276-82A9-444C69A512F3"}
 * @AllowToRunInFind
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"8517CEC6-ED67-4877-BA9F-59C00D19D141"}
 */
...
/**
 * @properties={typeid:24,uuid:"1B8F2D46-A314-48FB-8A8A-DDD6F9D87681"}
 */
...
/**
 * @properties={typeid:24,uuid:"7F7369CD-CC8E-4A3D-8E8E-8AF50015E56B"}
 */
