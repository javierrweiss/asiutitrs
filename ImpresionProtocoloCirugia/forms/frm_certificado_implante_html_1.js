 ...
 * @type {Date}
 *
 * @properties={typeid:35,uuid:"A473AE17-62A7-404D-8F02-5B5E99D574D5",variableType:93}
 */
var fecha_impresion = new Date();

/**
 * @properties={typeid:24,uuid:"29FBBD67-C984-413F-96FD-E2EC717D9B63"}
 * @AllowToRunInFind
 */
function sub_buildReport() {
	//plugins.dialogs.showInfoDialog("protocolo",globals.protocolo)
	globals.lineas_impre=0
	if(vhiscli2_to_tbc_protesis.getSize()>0){
...
/**
 * @properties={typeid:24,uuid:"D8BA829E-D4F7-4CF3-917D-986CBAA49BBB"}
 */
...
/**
 * @properties={typeid:24,uuid:"44961DC6-FA9D-4853-9207-4791FAEE137B"}
 */
