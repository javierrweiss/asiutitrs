	...
	if(resumen_to_hojauti.getSize()>0){
		for(var i=1;i<=resumen_to_hojauti.getSize();i++){
			...
			if(resumen_to_hojauti.hora>500){
				...
				globals.tabla1[2400]='Tensión Arterial Máxima'
				globals.tabla2[hora]=resumen_to_hojauti.param_ta_min
				globals.tabla2[2400]='Tensión Arterial Mínima'
				globals.tabla3[hora]=resumen_to_hojauti.param_fc
				globals.tabla3[2400]='Frecuecia Cardíaca     '	
				...
				globals.tabla8[2400]='Factor Corrección HGT  '
				...
				globals.tabla21[2400]='Tensión Arterial Media TAM'	
				globals.tabla22[hora]=resumen_to_hojauti.param_pic
				globals.tabla22[2400]='Presión Intr Craneana PIC'
