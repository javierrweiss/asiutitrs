 ...
 * @type {Boolean}
 *
 * @properties={typeid:35,uuid:"EB7742CE-2F79-4A52-BDF3-99B9B7A49D85",variableType:-4}
 */
var vClose = false;
 ...
 *
 * @properties={typeid:24,uuid:"30239E2E-CDDD-417E-9109-314D20572E03"}
 */
...
//////////////
	...
	try{
		if(vs_to_hojauti_block.getSize()>0){	
			...
			vs_to_hojauti_block.tipo_evolucion=2
 ...
 * @returns {Boolean}
 *
 * @properties={typeid:24,uuid:"FDEE7418-C9D9-4D5B-9716-E1DC65B48589"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"A5138AFC-FCCD-4254-898B-25519DA946CC"}
 */
function onShow_tabless_principal(firstShow, event) {
	...
	globals.name_tabless='tabless_principal_rcv_new'	
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"11514507-3D41-402E-BA8E-B5C352072821"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"8BC52AF4-9CBE-42FD-B668-15C7698DAB0A"}
 * @AllowToRunInFind
 */
function onAction_FechayHora(event) {
	...
	if (vs_to_hojauti.getSize()>0){
		...
		if(globals.vModifica&&globals.vSupervisor){
			globals.HabilitaDeshabilitaCampos('frm_parametros_rcv','nuevo')
			...
			globals.HabilitaDeshabilitaCampos('frm_parametros_rcv','consulta')
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"9FE9DB7D-5FBB-403B-B15B-1A8CEF1101DC"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"EC7259AB-8B19-465A-A286-5B431A301571"}
 */
function onAction_btn_limpia(event) {
		if(globals.vNuevaHoja&&!globals.vGrabado&&globals.nuevo_registro){
			...
			for(var i=1;i<=7;i++){
				forms.tabless_principal_rcv_new.elements.tabs_154.setTabFGColorAt(i,"#040404")
			}
		}
	globals.vEstadoAccion=''
	globals.vFecha=null
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"ADA4A8E8-0FF2-4B67-9451-D9764EEA2DB1"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"2F14EE54-E92F-40C6-918C-AF04B1117B43"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"4C116085-EABB-415E-97D5-48F67B1EF6D7"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"45CBA86D-DB6B-4360-A7A5-AD45F46EE8B4"}
 * @AllowToRunInFind
 */
...
/**
 * @properties={typeid:24,uuid:"7DFBD80A-E913-4E05-ACCE-2FBBA0164AB3"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"7CA48DA6-14E8-4E06-8AC4-AA11091142D8"}
 */
 ...
 * @returns {Boolean}
 *
 * @properties={typeid:24,uuid:"106D40E7-1285-4827-BF77-10AA6EFD5244"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"48706769-B456-41AD-BE45-B746C0069114"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"80ED1C0A-D2FD-4E9A-8A8F-C78929993CB7"}
 */
...
/**
 * @properties={typeid:24,uuid:"CCC77AB7-8C50-4B2F-8F17-27C0770DDA4B"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"812A60FD-B98E-4F4C-937C-B9FECB155822"}
 */
