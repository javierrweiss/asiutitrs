 ...
 * @type {Date}
 *
 * @properties={typeid:35,uuid:"65E39EBB-3D42-4302-96E2-F3C600F6BE11",variableType:93}
 */
var fecha_impresion = new Date();

/**
 * @properties={typeid:24,uuid:"5165C5DC-977A-47BF-B970-EEA9ACEDD1DD"}
 * @AllowToRunInFind
 */
...
/**
 * @properties={typeid:24,uuid:"1A231CE4-C4F6-4271-8306-DFE368D5D4A0"}
 */
...
/**
 * @properties={typeid:24,uuid:"1554961D-0E88-44A0-B066-6F98A18A0112"}
 */
function grabar_tmp() {
	var html = '';
	globals.tempHTML='';
...
/**
 * @properties={typeid:24,uuid:"B77BF4AB-072F-4140-9FD6-9F35CFE7BE95"}
 */
...
/**
 * @properties={typeid:24,uuid:"01FB3192-66A2-4DF2-8CCF-C5076295A033"}
 */
...
/**
 * @properties={typeid:24,uuid:"DE5A4AA4-788A-4162-A031-502857F3BE71"}
 */
function salto_hoja() {
	if(globals.lineas_impre<52){
