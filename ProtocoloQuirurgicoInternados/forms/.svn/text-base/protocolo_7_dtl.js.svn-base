/**
 * @properties={typeid:35,uuid:"1C153A2A-5854-47E9-846E-03D658C1ED35",variableType:-4}
 */
var borrado_ok2 = false;

/**
 * @properties={typeid:35,uuid:"794B3C1F-B338-4019-A22D-0881652E284D",variableType:-4}
 */
 ...
 *
 * @properties={typeid:24,uuid:"F290EC9D-78F9-4F76-BF89-050D4004A646"}
 */
function onAction_graba_protocolo_7(event) {
	if (globals.proto7!=null&&globals.proto7!=''){
		...
		*/
		...
		vs_to_tbl_protoc_txt.texto=globals.proto7
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"F4C48C19-6E00-4219-8168-F4D8FA57E741"}
 */
 ...
 * @param {JSEvent} event the event that triggered the action
 *
 * @properties={typeid:24,uuid:"F1393622-F145-42AF-99E0-6200DE7E634D"}
 */
...
/**
 * @properties={typeid:24,uuid:"EB49C436-C6A5-44B0-9119-2FE2F3E2C09A"}
 * @AllowToRunInFind
 */
